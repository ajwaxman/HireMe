...
1. Download the extension: {Demo Chrome Extension Link}[link:https://dropbox.com/s/t71z2sr4bnkkiw0/chrome_extension.zip]
...
You can also add companies to the database by selecting the browser extension while on a company profile on {Crunchbase}[link:https://crunchbase.com]
