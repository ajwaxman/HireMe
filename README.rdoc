...
1. Chrome Browser Extension for adding jobs and companies to the database
...
5. JQuery analytics dashboard and table views

6. Deployed via Capistrano to cloud server using Nginx and Passenger
...
3. Create an application.yml file the app/config/ directory and add your Crunchbase API key and Gmail username and password using the following syntax:
