...
HireMe is a CRM platform built to manage the interview process at the <a href="http://flatironschool.com">Flatiron School</a>. Students can browse job opportunities and keep track of progress with these companies and jobs.  
...
3. Create an application.yml file in the <tt>app/config</tt> directory and add your Crunchbase API key and Gmail username and password using the following syntax:
       CRUNCHBASE_API: "[Your Crunchbase API key]"
