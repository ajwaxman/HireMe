...
Check out the {demo version}[link:http://demo.hire.flatironschool.com/]! 

Demo student - email: student@example.com, password: student
Demo admin - email: admin@example.com, password: admin
...
1. Download the extension: {Demo Chrome Extension Link}[link:https://www.dropbox.com/s/t71z2sr4bnkkiw0/chrome_extension.zip]
...
You can also add companies to the database by selecting the browser extension while on a company profile on {Crunchbase}[link:https://www.crunchbase.com]
